    ...
    return (
        <div className='container p-20  mt-20 mb-10 bg-gray-900 w-[70%] pt-30 justify-items-center rounded-2xl'>
            ...
            <label for="email" class="block mb-10 text-3xl font-medium  text-gray-100 dark:text-gray-300">Add Hotel Meal</label>
                ...
                <div class="relative z-0 mb-8 w-full group">
                    <input type="text" name="floating_meal" id="floating_number" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" />
                ...
                <div class="relative z-0 mb-8 w-full group">
                    <input type="number" name="floating_meal" id="floating_meal" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" />
