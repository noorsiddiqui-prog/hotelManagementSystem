...
<footer class="  bg-gray-900 dark:bg-gray-900 pl-10">
    <div class="grid grid-cols-2 gap-8 py-8 px-10 md:grid-cols-4">
        <div>
    ...
    <div class="py-6 px-4 bg-gray-900 dark:bg-gray-700 md:flex md:items-center md:justify-between pl-10">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="#" class="text-gray-400 hover:text-[#cbd5e1] dark:hover:text-white">
